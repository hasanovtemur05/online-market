      ...
      <Layout className="h-[100vh] overflow-hidden">
        <Sider trigger={null} collapsible collapsed={collapsed}>
          ...
          <Menu
            ...
            items={admin.map((item: { icon: any; path: To; content: string | number | boolean | ReactElement<any, string | JSXElementConstructor<unknown>> | Iterable<ReactNode> | ReactPortal | ((props: NavLinkRenderProps) => React.ReactNode) | null | undefined; }, index: number) => ({
              key: index.toString(),
              icon: item.icon,
              label: (
